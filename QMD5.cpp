...
void QMD5::process(md5_state_t *pms, const md5_byte_t *data)
{
    md5_word_t
...
void QMD5::init(md5_state_t *pms)
{
...
void QMD5::append(md5_state_t *pms, const md5_byte_t *data, int nbytes)
{
...
void QMD5::finish(md5_state_t *pms, md5_byte_t digest[])
{
...
QString QMD5::ToBinary(const QString strHex)
{
	if( strHex.length() != 32 )
		return strHex;
	...
	{
		binWork[0] = strHex[i].toLatin1();
		binWork[1] = strHex[i + 1].toLatin1();
		binWork[2] = 0;
 ...
 ********************************************************************/
char QMD5::HexStringToChar(const QString &hexToConvert)
{
	unsigned int accumulated = 0;
	char char0[2] = {hexToConvert[0].toLatin1(), 0};
	char char1[2] = {hexToConvert[1].toLatin1(), 0};
 ...
 ********************************************************************/
QString QMD5::DigestToHexString(md5_byte_t *binaryDigest)
{
	char strReturn[32 + 1];
